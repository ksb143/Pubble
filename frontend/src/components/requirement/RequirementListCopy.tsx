...
// RequirementListCopy component의 props 정의
interface RequirementListProps {
  pId: number;
  pCode: string;
}

// RequirementListCopy component의 columns 정의
...
const RequirementListCopy = ({ pId, pCode }: RequirementListProps) => {
...
export default RequirementListCopy;
